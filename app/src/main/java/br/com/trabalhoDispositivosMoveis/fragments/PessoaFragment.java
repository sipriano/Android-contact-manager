...
import br.com.trabalhoDispositivosMoveis.activity.MainActivity;
...
public class PessoaFragment extends Fragment {
    ...
    private PessoaBean contatoExibido;
        ...
        cadastra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nome.isEmpty() || telefone.isEmpty()){
                    ...
                    PessoaBean pessoaBeanCadastro = new PessoaBean(video,musica,email,nome,telefone,endereco,site,foto,favorito);
                    int id ;
                    ...
                    id = (int) pessoaDao.inserirContato(pessoaBeanCadastro);
                    if(id != -1){
    ...
    public void onSaveInstanceState(Bundle outState) {
        if(fragmentoCriado){
            ...
            contatoExibido = new PessoaBean(video,musica,email,nome,telefone,site,favorito);
            if(imageViewFotoContato.getTag() != null){
