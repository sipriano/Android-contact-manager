package br.com.trabalhoDispositivosMoveis.bean;
...
public class PessoaBean implements Serializable {
    ...
    public PessoaBean(String videoFavorito, String musicaFavorita, String email, String nome, String celular, String endereco, String siteFavorito, String caminhoFoto, boolean favorito) {
    ...
    public PessoaBean(String videoFavorito, String musicaFavorita, String email, String nome, String celular, String siteFavorito, boolean favorito) {
        this.videoFavorito = videoFavorito;
        this.musicaFavorita = musicaFavorita;
        this.email = email;
        this.nome = nome;
